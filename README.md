...
## install
download path: https://github.com/suzuki-hoge/hub-board/blob/v2.1.1/publish/bin/hub-board?raw=true
...
$ git clone --depth=1 -b v2.1.1 git://github.com/suzuki-hoge/hub-board
